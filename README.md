...
# Conclusão do Protocolo Confirmatório

**Métrica primária**: `f1_weighted`  
**Alpha**: 0.05  
**Margem de equivalência**: 0.01

## Resultados por Imputador

| Imputador | Δ média | IC 95%            | p (perm) | p (Holm) | Equivalente? | Veredicto        |
| --------- | ------- | ----------------- | -------- | -------- | ------------ | ---------------- |
| Media     | +0.0050 | [-0.0075, 0.0174] | 0.4999   | 0.4999   | Não          | ❌ Sem evidência |

## ✅ Classe 88: Sem degradação significativa

---

_Gerado automaticamente por `run_protocol_stats.py`_
